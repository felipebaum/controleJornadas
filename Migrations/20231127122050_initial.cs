        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HrInicio = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HrFim = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dataAdmissao = table.Column<DateOnly>(type: "date", maxLength: 200, nullable: false),
                    codPix = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Jornadasid = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BasesUsuarios", x => new { x.BasesId, x.UsuariosId });
                    table.ForeignKey(
                        name: "FK_BasesUsuarios_Bases_BasesId",
                        column: x => x.BasesId,
                        principalTable: "Bases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BasesUsuarios_Usuarios_UsuariosId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasesUsuarios_UsuariosId",
                table: "BasesUsuarios",
                column: "UsuariosId");
